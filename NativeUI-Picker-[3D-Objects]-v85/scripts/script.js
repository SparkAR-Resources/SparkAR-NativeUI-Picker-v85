// 3D Objects - NativeUI Picker example v85
...
// we can start using our assets and creating the NativeUI Picker
    ...
    // Finally, we set the cubes
    const cube0 = results[6];
    const cube1 = results[7];
    const cube2 = results[8];
    ...
    picker.selectedIndex.monitor().subscribe(function(val) {
      ...
      // Pass the index to the switch to determine which cube should rotate
      switch(val.newValue) {
        case 0: {
           selectedCube = cube0;
           break;
      ...
      selectedCube.material = configuration.mats[val.newValue].material
      ...
      selectedCube.transform.rotationZ = spin;
